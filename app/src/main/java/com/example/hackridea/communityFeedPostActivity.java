...
public class communityFeedPostActivity extends AppCompatActivity {
    ...
    Bitmap bitmap;
    int select = 0;
    String url = "http://smvitmapp.xtoinfinity.tech/php/Hackridea/communityFeedPost.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_community_feed_post);
        ...
        postBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (title.equals("")) {
                    Toast.makeText(communityFeedPostActivity.this, "Please enter the title", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(communityFeedPostActivity.this, "Uploading, please wait", Toast.LENGTH_SHORT).show();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(communityFeedPostActivity.this, "" + error, Toast.LENGTH_SHORT).show();
                    }
                }
        ) {
            @Override
